...
while hasFrame(vidObj)
    movieFrames(k).cdata = imcrop(readFrame(vidObj),[450 250 500 500]);
    k = k+1;
end
...
% plot(frame0Stats(1).Centroid(1),frame0Stats(2).Centroid(2),'ro');
% hold off;
% pause (1);
% 
% imshow(BWframe180); hold on;
% plot(frame180Stats(1).Centroid(1),frame180Stats(2).Centroid(2),'ro');
